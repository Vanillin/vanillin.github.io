...
CreateNewElement("K.01.07", "main/images/models-K/K 1.7 20.20.png", 595 -200 , 1000, 20, 20);
...
CreateNewElement("K.01.03", "main/images/models-K/K 1.3 30.30.png", 593 -200 , 1000, 30, 30);
CreateNewElement("K.01.09", "main/images/models-K/K 1.9 30.30.png", 645 -200 , 1000, 30, 30);
CreateNewElement("K.01.04", "main/images/models-K/K 1.4 20.32.png", 644 -200 , 1000, 20, 32);
...
CreateNewElement("K.02.08", "main/images/models-K/K 2.8 43.43.png", 781 -150 , 1000, 43, 43);
...
CreateNewElement("K.02.10", "main/images/models-K/K 2.10 40.50.png", 786 -150 , 1000, 40, 50);
...
CreateNewElement("K.02.09", "main/images/models-K/K 2.9 53.58.png", 909 -150 , 1000, 53, 58);
...
CreateNewElement("K.03.07", "main/images/models-K/K 3.7 80.80.png", 1255 -100 , 1000, 80, 80);
