...
CreateNewElement("M.01.02", "main/images/models-M/M 1.2 24.12.png", 419 -200 + 60 , 1000, 12, 24);
CreateNewElement("M.01.07", "main/images/models-M/M 1.7 25.8.png", 394 -200 + 36, 1000, 8, 25);
CreateNewElement("M.01.04", "main/images/models-M/M 1.4 25.10.png", 360 -200 , 1000, 10, 25);
CreateNewElement("M.01.08", "main/images/models-M/M 1.8 25.10.png", 395 -200 + 55, 1000, 10, 25);
//CreateNewElement("M.01.06", "main/images/models-M/M 1.6 25.12.png", 436 -200 , 1000, 12, 25); //убрать
CreateNewElement("M.01.05", "main/images/models-M/M 1.5 30.10.png", 396 -200 , 1000, 16, 31);
CreateNewElement("M.01.03", "main/images/models-M/M 1.3 30.13.png", 482 -200 , 1000, 13, 29);
CreateNewElement("M.01.10", "main/images/models-M/M 1.10 35.12.png", 513 -200 , 1000, 14, 35);
CreateNewElement("M.01.09", "main/images/models-M/M 1.9 38.12.png", 480 -200 , 1000, 12, 36);

CreateNewElement("M.02.01", "main/images/models-M/M 2.1 41.16.png", 621 -150 + 14, 1000, 16, 41);
...
CreateNewElement("M.02.06", "main/images/models-M/M 2.6 50.22.png", 809 -150 +100 , 1000, 21, 50);
...
CreateNewElement("M.02.07", "main/images/models-M/M 2.7 60.25.png", 1075 -150 -200, 1000, 23, 59);

//CreateNewElement("M.03.02", "main/images/models-M/M 3.2 70.17.png", 883 -100 , 1000, 17, 70); убрать
CreateNewElement("M.03.01", "main/images/models-M/M 3.1 80.30.png", 1473 -100 -400, 1000, 30, 80);

CreateNewElement("M.04.01", "main/images/models-M/M 4.1 95.25.png", 1460, 1000 -400, 25, 95);